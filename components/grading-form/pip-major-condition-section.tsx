...
import { pipMajorConditionRows } from "./pip-major-condition-data";

export function PipMajorConditionSection() {
  return (
    <GradingFormSection title="Identifikasi Kondisi Major">
      <div className="overflow-x-auto">
        <table className="w-full min-w-[840px] border-collapse text-sm text-neutral-950">
          <thead>
