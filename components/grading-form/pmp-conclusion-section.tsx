...
import { getPmpNextInspectionInterval } from "./pmp-conclusion-data";

type PmpConclusionSectionProps = {
  totalScore: number;
  improvementParameters: string[];
};

export function PmpConclusionSection({
  totalScore,
  improvementParameters,
}: PmpConclusionSectionProps) {
  const nextInspectionInterval = getPmpNextInspectionInterval(totalScore);
    ...
    <GradingFormSection title="Kesimpulan">
      <div className="grid grid-cols-[minmax(220px,0.8fr)_16px_minmax(320px,1fr)] gap-x-6 gap-y-6 text-sm text-neutral-950 max-md:grid-cols-1">
        <label
          ...
          htmlFor="pmp-next-inspection-interval"
        >
        ...
        <div className="flex items-center">
          <input
            ...
            id="pmp-next-inspection-interval"
            type="number"
        ...
        <label
          className="py-2 font-medium text-neutral-700"
          htmlFor="pmp-major-condition-summary"
        >
        ...
        <textarea
          ...
          id="pmp-major-condition-summary"
        />

        <label
          className="py-2 font-medium text-neutral-700"
          htmlFor="pmp-improvement-parameters"
        >
        ...
        <label className="py-2 font-medium text-neutral-700" htmlFor="pmp-notes">
          Catatan
        </label>
        <span className="py-2 text-center text-neutral-400 max-md:hidden">:</span>
        <textarea
