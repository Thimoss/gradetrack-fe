    ...
    <GradingFormSection title="Pengambilan Data Lapangan">
      <div className="grid grid-cols-[minmax(420px,0.7fr)_minmax(260px,1fr)] gap-8 rounded-lg border border-zinc-200 p-5 max-lg:grid-cols-1 max-sm:overflow-x-auto">
        <div>
          ...
          <table className="mt-3 w-full min-w-[420px] border-collapse text-center text-sm text-[#232122]">
            <thead>
                ...
                <tr key={row}>
                  ...
                  <td className="border border-zinc-200 p-0">
                    <input
                      ...
                      className="h-9 w-full border border-transparent bg-slate-100 px-2 text-center outline-none transition focus:border-[#036CB6] focus:bg-white"
                      type="number"
                      step="0.1"
                      readOnly
                    />
