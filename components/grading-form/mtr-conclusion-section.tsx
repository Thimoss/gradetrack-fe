...
import { getMtrNextInspectionInterval } from "./mtr-conclusion-data";

type MtrConclusionSectionProps = {
  totalScore: number;
  improvementParameters: string[];
};

export function MtrConclusionSection({
  totalScore,
  improvementParameters,
}: MtrConclusionSectionProps) {
  const nextInspectionInterval = getMtrNextInspectionInterval(totalScore);
    ...
    <GradingFormSection title="Kesimpulan">
      <div className="grid grid-cols-[minmax(220px,0.8fr)_16px_minmax(320px,1fr)] gap-x-6 gap-y-6 text-sm text-neutral-950 max-md:grid-cols-1">
        <label
          ...
          htmlFor="mtr-next-inspection-interval"
        >
        ...
        <div className="flex items-center">
          <input
            ...
            id="mtr-next-inspection-interval"
            type="number"
        ...
        <label
          className="py-2 font-medium text-neutral-700"
          htmlFor="mtr-major-condition-summary"
        >
        ...
        <textarea
          ...
          id="mtr-major-condition-summary"
        />

        <label
          className="py-2 font-medium text-neutral-700"
          htmlFor="mtr-improvement-parameters"
        >
        ...
        <textarea
          className="h-32 w-full resize-none rounded-lg border border-zinc-200 bg-slate-100 p-3 outline-none focus:bg-white focus:ring-2 focus:ring-sky-500"
          id="mtr-improvement-parameters"
          value={improvementParameters.join(", ")}
          readOnly
        />

        <label className="py-2 font-medium text-neutral-700" htmlFor="mtr-notes">
          Catatan
        </label>
        <span className="py-2 text-center text-neutral-400 max-md:hidden">:</span>
        <textarea
